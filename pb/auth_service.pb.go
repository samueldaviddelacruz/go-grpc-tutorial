...
var file_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: grpc_tutorial.proto.LoginRequest
	(*LoginResponse)(nil), // 1: grpc_tutorial.proto.LoginResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: grpc_tutorial.proto.AuthService.Login:input_type -> grpc_tutorial.proto.LoginRequest
	1, // 1: grpc_tutorial.proto.AuthService.Login:output_type -> grpc_tutorial.proto.LoginResponse
