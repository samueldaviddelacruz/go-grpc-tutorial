...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\x13grpc_tutorial.proto\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x15storage_message.proto\x1a\x14screen_message.proto\x1a\x16keyboard_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb8\x04\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12*\n" +
	"\x03cpu\x18\x04 \x01(\v2\x18.grpc_tutorial.proto.CPUR\x03cpu\x12-\n" +
	"\x03ram\x18\x05 \x01(\v2\x1b.grpc_tutorial.proto.MemoryR\x03ram\x12,\n" +
	"\x04gpus\x18\x06 \x03(\v2\x18.grpc_tutorial.proto.GPUR\x04gpus\x128\n" +
	"\bstorages\x18\a \x03(\v2\x1c.grpc_tutorial.proto.StorageR\bstorages\x123\n" +
	"\x06screen\x18\b \x01(\v2\x1b.grpc_tutorial.proto.ScreenR\x06screen\x129\n" +
	"\bkeyboard\x18\t \x01(\v2\x1d.grpc_tutorial.proto.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
	...
	"\x06weightB\x15Z\x13grpc_tutorial.protob\x06proto3"
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: grpc_tutorial.proto.Laptop
	(*CPU)(nil),                   // 1: grpc_tutorial.proto.CPU
	(*Memory)(nil),                // 2: grpc_tutorial.proto.Memory
	(*GPU)(nil),                   // 3: grpc_tutorial.proto.GPU
	(*Storage)(nil),               // 4: grpc_tutorial.proto.Storage
	(*Screen)(nil),                // 5: grpc_tutorial.proto.Screen
	(*Keyboard)(nil),              // 6: grpc_tutorial.proto.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: grpc_tutorial.proto.Laptop.cpu:type_name -> grpc_tutorial.proto.CPU
	2, // 1: grpc_tutorial.proto.Laptop.ram:type_name -> grpc_tutorial.proto.Memory
	3, // 2: grpc_tutorial.proto.Laptop.gpus:type_name -> grpc_tutorial.proto.GPU
	4, // 3: grpc_tutorial.proto.Laptop.storages:type_name -> grpc_tutorial.proto.Storage
	5, // 4: grpc_tutorial.proto.Laptop.screen:type_name -> grpc_tutorial.proto.Screen
	6, // 5: grpc_tutorial.proto.Laptop.keyboard:type_name -> grpc_tutorial.proto.Keyboard
	7, // 6: grpc_tutorial.proto.Laptop.updated_at:type_name -> google.protobuf.Timestamp
