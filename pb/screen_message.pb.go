...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,3,opt,name=panel,proto3,enum=grpc_tutorial.proto.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\x13grpc_tutorial.proto\"\xab\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12F\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2&.grpc_tutorial.proto.Screen.ResolutionR\n" +
	"resolution\x127\n" +
	"\x05panel\x18\x03 \x01(\x0e2!.grpc_tutorial.proto.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
	...
	"\x04OLED\x10\x02B\x15Z\x13grpc_tutorial.protob\x06proto3"
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: grpc_tutorial.proto.Screen.Panel
	(*Screen)(nil),            // 1: grpc_tutorial.proto.Screen
	(*Screen_Resolution)(nil), // 2: grpc_tutorial.proto.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpc_tutorial.proto.Screen.resolution:type_name -> grpc_tutorial.proto.Screen.Resolution
	0, // 1: grpc_tutorial.proto.Screen.panel:type_name -> grpc_tutorial.proto.Screen.Panel
