...
type Memory struct {
	...
	Unit          Memory_Unit            `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc_tutorial.proto.Memory_Unit" json:"unit,omitempty"`
...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\x13grpc_tutorial.proto\"\xb4\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x124\n" +
	"\x04unit\x18\x02 \x01(\x0e2 .grpc_tutorial.proto.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
	...
	"\bTERABYTE\x10\x06B\x15Z\x13grpc_tutorial.protob\x06proto3"
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: grpc_tutorial.proto.Memory.Unit
	(*Memory)(nil),   // 1: grpc_tutorial.proto.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc_tutorial.proto.Memory.unit:type_name -> grpc_tutorial.proto.Memory.Unit
