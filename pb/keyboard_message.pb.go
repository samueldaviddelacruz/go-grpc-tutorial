...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=grpc_tutorial.proto.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\x13grpc_tutorial.proto\"\x9d\x01\n" +
	"\bKeyboard\x12<\n" +
	"\x06layout\x18\x01 \x01(\x0e2$.grpc_tutorial.proto.Keyboard.LayoutR\x06layout\x12\x18\n" +
	...
	"\n" +
	"\x06AZERTY\x10\x03B\x15Z\x13grpc_tutorial.protob\x06proto3"
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: grpc_tutorial.proto.Keyboard.Layout
	(*Keyboard)(nil),     // 1: grpc_tutorial.proto.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: grpc_tutorial.proto.Keyboard.layout:type_name -> grpc_tutorial.proto.Keyboard.Layout
