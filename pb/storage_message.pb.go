...
type Storage struct {
	...
	Driver        Storage_Driver         `protobuf:"varint,1,opt,name=driver,proto3,enum=grpc_tutorial.proto.Storage_Driver" json:"driver,omitempty"`
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\x13grpc_tutorial.proto\x1a\x14memory_message.proto\"\xa4\x01\n" +
	"\aStorage\x12;\n" +
	"\x06driver\x18\x01 \x01(\x0e2#.grpc_tutorial.proto.Storage.DriverR\x06driver\x123\n" +
	"\x06memory\x18\x02 \x01(\v2\x1b.grpc_tutorial.proto.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\a\n" +
	"\x03HDD\x10\x01\x12\a\n" +
	"\x03SSD\x10\x02B\x15Z\x13grpc_tutorial.protob\x06proto3"
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: grpc_tutorial.proto.Storage.Driver
	(*Storage)(nil),     // 1: grpc_tutorial.proto.Storage
	(*Memory)(nil),      // 2: grpc_tutorial.proto.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc_tutorial.proto.Storage.driver:type_name -> grpc_tutorial.proto.Storage.Driver
	2, // 1: grpc_tutorial.proto.Storage.memory:type_name -> grpc_tutorial.proto.Memory
